		...
		colors: [
			{
				id: 1,
				name: 'черный',
				images: [`${process.env.PUBLIC_URL}/images/1/black_front.png`, `${process.env.PUBLIC_URL}/images/1/black_back.png`],
				price: '123.00',
			...
			},
			{
				id: 2,
				name: 'белый',
				images: [`${process.env.PUBLIC_URL}/images/1/white_front.png`, `${process.env.PUBLIC_URL}/images/1/white_back.png`],
				price: '125.00',
			...
			},
			{
				id: 3,
				name: 'серый',
				images: [`${process.env.PUBLIC_URL}/images/1/gray_front.png`, `${process.env.PUBLIC_URL}/images/1/gray_back.png`],
				price: '120.00',
		...
		colors: [
			{
				id: 1,
				name: 'желтый',
				images: [`${process.env.PUBLIC_URL}/images/2/yellow_front.png`, `${process.env.PUBLIC_URL}/images/2/yellow_back.png`],
				price: '88.00',
			...
			},
			{
				id: 2,
				name: 'синий',
				images: [`${process.env.PUBLIC_URL}/images/2/blue_front.png`, `${process.env.PUBLIC_URL}/images/2/blue_back.png`],
				price: '89.00',
			...
			},
			{
				id: 3,
				name: 'черный',
				images: [`${process.env.PUBLIC_URL}/images/2/black_front.png`, `${process.env.PUBLIC_URL}/images/2/black_back.png`],
				price: '90.00',
